...
LuaTele = luatele.set_config{api_id=12332821,api_hash='c27120146b483d7ba0b271c9282078df',session_name=black,token=Token}
function var(value)
...
send(msg.chat_id,msg.id,"➢ مرحبا عزيزي في مصنع الحمايه المجاني لسورس الجبوري \n➢ مبرمج السورس @J_B_4","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
----
if text == 'المطور الجبوري' or text == 'مبرمج السورس' or text == 'الجبوري' then  
...
❍ 𝐷𝐸𝑉 >> [˹ 𝐂𝐎𝐒𝐓 .](t.me/J_B_4)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ 
❍ـــ❍ >> [˹ 𝑆𝑂𝑈𝑅𝑆𝐸 𝐂𝐎𝐒𝐓 .](t.me/co_st1)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' 𝑆𝑂𝑈𝑅𝑆𝐸 𝐂𝐎𝐒𝐓',  url = 't.me/co_st1'}, 
},
}
